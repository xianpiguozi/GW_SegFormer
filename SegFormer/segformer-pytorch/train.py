...
if __name__ == "__main__":
    ...
    #   读取数据集对应的txt
    #---------------------------#
    with open(os.path.join(VOCdevkit_path, "self_data/ImageSets/Segmentation8036/train.txt"),"r") as f:
        train_lines = f.readlines()
    with open(os.path.join(VOCdevkit_path, "self_data/ImageSets/Segmentation8036/val.txt"),"r") as f:
    ...
    if True:
        ...
        optimizer = {
            ...
            'adamw': optim.AdamW(model.parameters(), lr = 1e-3, betas=(momentum, 0.999), weight_decay=weight_decay),
