...
if __name__ == "__main__":
    ...
    segfilepath     = os.path.join(VOCdevkit_path, 'self_data/SegmentationClass_8000_and_snr6_8')
    saveBasePath    = os.path.join(VOCdevkit_path, 'self_data/ImageSets/Segmentation_8000_and_snr6_8')
